...
async function sendConfirmationEmail(email, fullName, mobileNumber,  problemStatement, teamId) {
    const mailOptions = {
        ...
        <p>We are thrilled to inform you that your team  has been successfully registered for <b>Hack GenX 2025</b>.</p>
        ...
        <p>3. <b>Submission Process:</b> Send your presentation (PPT) to <a href="mailto:innovatexh@gmail.com">innovatexh@gmail.com</a> with the subject line: <i>"Screening Round - ${teamId}}"</i></p>
        ...
        <ul>
            <li>Email: <a href="mailto:innovatexh@gmail.com">innovatexh@gmail.com</a></li>
